  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'gradient-retail':  'linear-gradient(135deg, #3b82f6 0%, #6366f1 100%)',
        'gradient-corporate':'linear-gradient(135deg, #8b5cf6 0%, #6d28d9 100%)',
        'gradient-merchant':'linear-gradient(135deg, #f97316 0%, #ea580c 100%)',
        'gradient-vendor':  'linear-gradient(135deg, #14b8a6 0%, #0d9488 100%)',
      ...
      animation: {
        ...
        'slide-in-left': 'slideInLeft 0.3s cubic-bezier(.16,1,.3,1)',
        'pulse-dot':     'pulseDot 1.5s ease-in-out infinite',
        'pulse-ring':    'pulseRing 2s ease-out infinite',
        'shimmer':       'shimmer 2s ease-in-out infinite',
        'glow':          'glowPulse 2s ease-in-out infinite',
        'bounce-sm':     'bounceSm 1s ease-in-out infinite',
        'count-up':      'countUp 0.4s cubic-bezier(.16,1,.3,1)',
      ...
      keyframes: {
        ...
        glowPulse:    { '0%,100%': { boxShadow: '0 0 8px 0 rgba(99,102,241,.4)' },      '50%': { boxShadow: '0 0 22px 4px rgba(99,102,241,.6)' } },
